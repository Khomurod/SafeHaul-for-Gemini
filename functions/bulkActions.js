    ...
    try {
        ...
        // B. CRM QUERY MODE
            ...
            if (filters.segmentId && filters.segmentId !== 'all') {
                ...
                // If user specifies a limit (e.g. 50), we only fetch 50 IDs.
                // NOTE: We assume 'orderBy' is not strictly required unless randomizing.
                // Defaulting to creation time or natural order.
                const campaignLimit = filters.campaignLimit ? parseInt(filters.campaignLimit) : 5000;
