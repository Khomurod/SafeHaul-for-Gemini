...
export function SafeHaulLeadsDriverModal({ lead, onClose, onCallStart }) {
  ...
  const lastName = lead.lastName || 'Driver';
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center mt-1">
                                            <span className={`inline-flex px-2 py-1 text-xs rounded font-medium border ${
                                                sourceInputLabel === 'None' ? 'bg-gray-100 text-gray-500 border-gray-200' :
