...
export function SuperAdminDashboard() {
  ...
  const handleFixData = async () => {
    // FIXED: Updated message to reflect actual function behavior (Quota Initialization)
    if(!window.confirm("Run 'Quota Initialization'? This ensures all companies have a valid daily quota set.")) return;

    setFixingData(true);
    showInfo("Initializing quotas...");

    try {
        const fixFn = httpsCallable(functions, 'runMigration'); // Renamed for clarity
