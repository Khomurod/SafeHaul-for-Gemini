...
import {
  ...
  FileText, UserCheck, Folder, FileSignature, MessageSquare, Clock, Mail, Briefcase
} from 'lucide-react';

// --- Local Feature Imports (New Structure) ---
import { ApplicationInfo } from './application';
import { DQFileTab, GeneralDocumentsTab, NotesTab, ActivityHistoryTab, PEVTab } from './tabs';
...
export function ApplicationDetailView({
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'contact': return <ContactTab companyId={companyId} recordId={applicationId} collectionName={collectionName} email={appData.email} phone={appData.phone} applicantData={appData} />;
      case 'dqFile': return <DQFileTab companyId={companyId} applicationId={applicationId} collectionName={collectionName} />;
      case 'pev': return <PEVTab companyId={companyId} applicationId={applicationId} appData={appData} />;
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-64 bg-gray-100/50 border-r border-gray-200 p-4 flex flex-col gap-1 overflow-y-auto shrink-0">
            ...
            <div className="space-y-1">
              ...
              <SideTab label="Prev. Employments" icon={<Briefcase size={18} />} isActive={activeTab === 'pev'} onClick={() => setActiveTab('pev')} />
