...
const Step9_Consent = ({ formData, updateFormData, onNavigate, onFinalSubmit, handleFileUpload }) => {
    ...
    // Wrapper for file upload inside agreement box
        ...
        <div id="page-9" className="form-step space-y-6">
            ...
            >
                ...
                <div className="space-y-2 pt-4 border-t border-gray-200">
                    <InputField 
                        label="Upload Drug Test Consent Form (Optional)" 
                        id="drug-test-consent-upload" 
                        name="drug-test-consent-upload" 
                        type="file"
                        onChange={(name, file) => onFileChange(name, file)}
                    />
                </div>
            </AgreementBox>
            ...
            <fieldset className="border border-gray-300 rounded-lg p-4 space-y-4 mt-6 bg-white">
                ...
                {/* --- TYPED SIGNATURE SECTION (NO CANVAS) --- */}
