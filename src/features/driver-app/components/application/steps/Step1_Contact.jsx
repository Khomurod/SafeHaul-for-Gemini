        ...
        <div id="page-1" className="form-step space-y-6">
            ...
            {showPreviousAddress && (
                <div className="mt-6 animate-in fade-in">
                    <h4 className="text-lg font-semibold text-gray-800 px-2 mb-2">Previous Address History (Past 3 Years)</h4>
                    <p className="text-sm text-gray-600 px-2 mb-4">Please list all addresses where you have resided in the past 3 years.</p>
