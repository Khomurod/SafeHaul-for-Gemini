...
import {
    ...
    FileSignature, Blocks, ArrowLeft, Users, Mail, Facebook, Briefcase
} from 'lucide-react';
...
export function CompanySettings() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'facebook':
                return (
                    <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8 bg-white border border-gray-200 rounded-xl">
                        <div className="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mb-6">
                            <Facebook size={32} />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-2">Facebook Integration</h3>
                        <p className="text-gray-500 max-w-md mx-auto mb-8">
                            Connect your Facebook Ads Lead Forms directly to SafeHaul. Automatically import leads and start recruiting instantly.
                        </p>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-bold">
                            <Blocks size={16} /> Coming Soon
                        </div>
                    </div>
                );
            case 'billing':
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <aside className="w-full md:w-64 flex-shrink-0">
                        <div className="sticky top-24 space-y-1 bg-white/50 backdrop-blur-md rounded-2xl p-2 border border-slate-200/60 shadow-sm">
                            ...
                            <SidebarItem id="facebook" label="Facebook Ads" icon={Facebook} activeTab={activeTab} onClick={setActiveTab} />
