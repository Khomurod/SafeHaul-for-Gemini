                            ...
                            <>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 border-t border-slate-100 pt-4 mt-2">
                                        <div>
                                            <label className="block text-xs font-bold text-slate-500 uppercase mb-2">Volume Limit</label>
                                            <input
                                                type="number"
                                                placeholder="Max leads (e.g. 50)"
                                                className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl font-medium outline-none focus:ring-2 focus:ring-blue-100"
                                                value={filters.campaignLimit || ''}
                                                onChange={(e) => handleChange('campaignLimit', e.target.value)}
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-xs font-bold text-slate-500 uppercase mb-2">Spam Protection</label>
                                            <label className="flex items-center gap-3 p-3 bg-slate-50 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-100 transition-colors">
                                                <input
                                                    type="checkbox"
                                                    checked={!!filters.excludeRecentDays}
                                                    onChange={(e) => handleChange('excludeRecentDays', e.target.checked)}
                                                    className="w-4 h-4 rounded text-blue-600 focus:ring-blue-500"
                                                />
                                                <span className="text-sm font-medium text-slate-700">Exclude recently contacted (7 days)</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
