...
const DriverGeneralSignup = React.lazy(() => import('@features/auth/components/DriverGeneralSignup'));
...
const JobBoard = React.lazy(() => import('@features/driver-app/components/JobBoard'));
  ...
  return (
    <Suspense fallback={<GlobalLoadingState />}>
      <Routes>
        ...
        {/* NEW: General Driver Registration */}
        <Route path="/drivers/register" element={<DriverGeneralSignup />} />
        ...
        <Route path="/driver/jobs" element={
          <ProtectedRoute allowedRoles={['driver']}>
            <React.Suspense fallback={<GlobalLoadingState />}>
              {/* Lazy load inline or import at top */}
              <JobBoard />
            </React.Suspense>
          </ProtectedRoute>
        } />
